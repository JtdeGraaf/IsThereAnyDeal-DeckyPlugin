 ...
 * Comlete copy of https://github.com/SteamGridDB/decky-steamgriddb/blob/main/src/components/qam-contents/PanelSocialButton.tsx, except that I removed i18n translations
 */
